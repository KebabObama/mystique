...
export namespace Game {
  ...
  export type Campfire = typeof schema.campfire.$inferSelect & {
    shopItems: Array<CampfireShopEntry>;
  };
  ...
  export type EntityPatch<T extends { id: string }> = {
    upsert?: Array<T>;
    remove?: Array<T["id"]>;
  };
