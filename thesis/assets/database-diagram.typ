...
#figure(
  diagram(
    ...
    node((2, 1), align(center)[*verification*\ #text(size: 8pt)[id · identifier\ value · expires_at]], name: <verification>),

    node((0, 2), align(center)[*character*\ #text(size: 8pt)[id · name · race · level\ owner_id · lobby_id\ attributes · hp · stamina]], name: <char>),
    node((2, 2), align(center)[*lobby*\ #text(size: 8pt)[id · name · data\ master_id · created_at]], name: <lobby>),

    node((0, 3), align(center)[*inventory*\ #text(size: 8pt)[character_id · item_id\ quantity · equipped]], name: <inv>),
    node((1, 3), align(center)[*lobby_member*\ #text(size: 8pt)[lobby_id · user_id\ last_seen · last_read_at]], name: <lm>),
    ...
    node((2, 4), align(center)[*lobby_entity*\ #text(size: 8pt)[id · lobby_id · type\ character_id · monster_id\ chest_id · campfire_id\ position · actions]], name: <le>),

    node((0, 5), align(center)[*monster*\ #text(size: 8pt)[id · name · level\ hp · armor · stamina\ abilities]], name: <mon>),
  ...
  caption: [Entity-Relationship diagram databázového schématu aplikace Mystique],
) <fig-er-diagram>
