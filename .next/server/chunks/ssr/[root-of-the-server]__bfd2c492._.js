...
"[project]/lib/minio.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const minio = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$minio$2f$dist$2f$esm$2f$minio$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Client"]({
    endPoint: process.env.S3_ENDPOINT || "localhost",
    port: Number.parseInt(process.env.S3_PORT, 10),
    useSSL: false,
    accessKey: process.env.S3_ROOT_USER,
    secretKey: process.env.S3_ROOT_PASSWORD
});
const createBucket = async (bucketName, isPrivate = true)=>{
...
const getUrl = async (bucket, object, isPrivate = true)=>{
    try {
...
"[project]/lib/photo.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

/* __next_internal_action_entry_do_not_use__ [{"7f12f7a96b986b8c47d08fa864dfa01765e92b068a":"uploadFromUrl","7f3a6a39dfe58be1289f23597420b5a6a9780dc347":"ensureAvatarUploaded"},"",""] */ __turbopack_context__.s([
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$minio$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/minio.ts [app-rsc] (ecmascript)");
...
;
;
const uploadFromUrl = async (url, bucketName, objectName, isPrivate = false)=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$minio$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createBucket"])(bucketName, isPrivate);
        const response = await fetch(url);
        if (!response.ok) throw new Error(`Failed to fetch image: ${response.statusText}`);
        const buffer = Buffer.from(await response.arrayBuffer());
        const contentType = response.headers.get("content-type") || "application/octet-stream";
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$minio$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["minio"].putObject(bucketName, objectName, buffer, buffer.length, {
...
const ensureAvatarUploaded = async (user)=>{
    if (!user?.image?.startsWith("http")) return;
    const objectName = `avatars/${user.id}`;
    const uploaded = await uploadFromUrl(user.image, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$minio$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["BUCKETS"].AVATARS, objectName, false);
    if (uploaded) await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["auth"].api.updateUser({
        body: {
            image: objectName
        }
    });
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(uploadFromUrl, "7f12f7a96b986b8c47d08fa864dfa01765e92b068a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(ensureAvatarUploaded, "7f3a6a39dfe58be1289f23597420b5a6a9780dc347", null);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$photo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/photo.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/headers.js [app-rsc] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$photo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$photo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
;
;
const __TURBOPACK__default__export__ = async ({ children })=>{
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$photo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ensureAvatarUploaded"])(session?.user);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bfd2c492._.js.map