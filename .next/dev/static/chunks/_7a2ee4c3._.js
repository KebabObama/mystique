...
const FriendsProvider = ({ children })=>{
    ...
    const sendRequest = (receiverId)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Request sent");
    };
    const acceptRequest = (senderId)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Request accepted");
    };
    const denyRequest = (senderId)=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Request denied");
    };
    const refresh = ()=>{
        if (!user) return;
        ...
        "MessageProvider.useEffect": ()=>{
            ...
            socket.on("message", {
                "MessageProvider.useEffect": (message)=>{
                    ...
                    if (message.data.sender.id !== user.id) __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].show(`${message.data.sender.name}: ${message.data.text}`);
                }
            }["MessageProvider.useEffect"]);
...
//# sourceMappingURL=_7a2ee4c3._.js.map