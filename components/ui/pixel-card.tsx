...
export default ({
	...
	return (
		<div
			...
			aria-hidden="true"
			ref={containerRef}
			className={`relative isolate grid h-[400px] w-[300px] place-items-center overflow-hidden rounded-[25px] border border-[#27272a] transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
